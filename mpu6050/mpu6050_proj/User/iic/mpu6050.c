...
uint8_t Mpu6050_Init(uint16_t sampleRate, uint8_t flagDLPF)
{
	...
	*/
	...
	data = 0x03<<3;//gyroscope full scale range ±2000°/s
	if(I2C1_WriteData(MPU6050_ADDRESS, GYRO_CONFIG, &data, 1))
	{
		return 11;
	}
	data = 0x00;//accelerometer full scale range ±2g
...
uint8_t Mpu6050_GetAccelData(void)
{
	...
	Mpu6050_Accel_X = AccelData[0]/FACTOR_ACCEL_RANGE_2;//±2g	
	Mpu6050_Accel_Y = AccelData[1]/FACTOR_ACCEL_RANGE_2;//±2g	
	Mpu6050_Accel_Z = AccelData[2]/FACTOR_ACCEL_RANGE_2;//±2g
...
uint8_t Mpu6050_GetGyroData(void)
{
	...
	Mpu6050_Gyro_X = GyroData[0]/FACTOR_GYRO_RANGE_2000;//±2000°/s
	Mpu6050_Gyro_Y = GyroData[1]/FACTOR_GYRO_RANGE_2000;//±2000°/s
	Mpu6050_Gyro_Z = GyroData[2]/FACTOR_GYRO_RANGE_2000;//±2000°/s
