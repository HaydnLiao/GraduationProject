...
void Lipo_CalVoltage(float calWeight)
{
	...
	*/
	...
	//Lipo_Voltage = calWeight*Lipo_Voltage + (1-calWeight)*(ADC1_Value/4096*3.3/1.5*11.5);
	Lipo_Voltage = calWeight*Lipo_Voltage + (1-calWeight)*(ADC1_Value*0.0061767578125);
